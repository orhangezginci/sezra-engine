...
# Demo-Szenario: ein Lieferantenwechsel beim Zellkulturmedium (erfasst
# als Systemeintrag im Beschaffungs-/Bestandsverwaltungssystem, nicht als
# handgeschriebene Notiz) fuehrt zu einem Rueckgang der Zellviabilitaet
# in einem Labor-Bioreaktor - ein reales, bekanntes Laborphaenomen
# (minimale Zusammensetzungsunterschiede zwischen Medien-Chargen
# verschiedener Lieferanten koennen die Zellkultur beeinflussen). Nicht
# offensichtlich, wenn das Laborteam den Wechsel nicht sofort mit dem
# Rueckgang in Verbindung bringt.
#
# Metrik-zu-Text-Muster wie School/DevOps: cell_culture_viability_rate
...
echo "=== SEZRA Demo: Biotech - Zellkultur/Lieferantenwechsel (Metrik <- Text) ==="
echo ""
